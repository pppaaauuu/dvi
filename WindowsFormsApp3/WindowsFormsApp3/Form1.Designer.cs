namespace WindowsFormsApp3
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dataTable1TableAdapter = new WindowsFormsApp3.Properties.DataSet1TableAdapters.DataTable1TableAdapter();
            this.dataSet2BindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.dataTableTableAdapter = new WindowsFormsApp3.Properties.DataSet2TableAdapters.DataTableTableAdapter();
            this.tableAdapterManager = new WindowsFormsApp3.Properties.DataSet2TableAdapters.TableAdapterManager();
            this.dataTablemTableAdapter = new WindowsFormsApp3.Properties.DataSet3TableAdapters.DataTablemTableAdapter();
            this.dataTableBindingSource1 = new System.Windows.Forms.BindingSource(this.components);
            this.dataTablejustAdapter = new WindowsFormsApp3.Properties.DataSet4TableAdapters.DataTablejustAdapter();
            ...
            // 
            // datajustBindingSource
            // 
            this.datajustBindingSource.DataMember = "Datajust";
            this.datajustBindingSource.DataSource = this.dataSet4;
            // 
            // dataSet4
            // 
            ...
            // 
            this.datahodBindingSource.DataMember = "Datahod";
            // 
            // dataTablemBindingSource
            // 
            this.dataTablemBindingSource.DataMember = "DataTablem";
            this.dataTablemBindingSource.DataSource = this.dataSet3;
            // 
            // dataSet3
            // 
            ...
            this.button1.Location = new System.Drawing.Point(322, 24);
            ...
            this.reportViewer2.LocalReport.ReportEmbeddedResource = "WindowsFormsApp3.Report2.rdlc";
            ...
            this.reportViewer3.BackColor = System.Drawing.Color.LightGray;
            this.reportViewer3.Dock = System.Windows.Forms.DockStyle.Fill;
            this.reportViewer3.DocumentMapWidth = 1;
            reportDataSource3.Name = "Datajust";
            reportDataSource3.Value = this.datajustBindingSource;
            this.reportViewer3.LocalReport.DataSources.Add(reportDataSource3);
            this.reportViewer3.LocalReport.ReportEmbeddedResource = "WindowsFormsApp3.Report3.rdlc";
            ...
            this.button2.Location = new System.Drawing.Point(473, 20);
            this.button2.Name = "button2";
            this.button2.Size = new System.Drawing.Size(89, 39);
            this.button2.TabIndex = 2;
            this.button2.Text = "Generar justificant";
            this.button2.UseVisualStyleBackColor = false;
            this.button2.Click += new System.EventHandler(this.button2_Click);
            // 
            // comboBox2
            // 
            this.comboBox2.DataSource = this.dataTablemBindingSource;
            this.comboBox2.DisplayMember = "COGNOM";
            this.comboBox2.FormattingEnabled = true;
            this.comboBox2.Location = new System.Drawing.Point(130, 28);
            this.comboBox2.Name = "comboBox2";
            this.comboBox2.Size = new System.Drawing.Size(304, 21);
            this.comboBox2.TabIndex = 1;
            this.comboBox2.ValueMember = "INSCRIPCIO";
            // 
            // label2
            // 
            ...
            // reportViewer4
            // 
            this.reportViewer4.BackColor = System.Drawing.Color.LightGray;
            this.reportViewer4.Dock = System.Windows.Forms.DockStyle.Fill;
            reportDataSource4.Name = "dh";
            reportDataSource4.Value = this.dataTable1BindingSource2;
            this.reportViewer4.LocalReport.DataSources.Add(reportDataSource4);
            this.reportViewer4.LocalReport.ReportEmbeddedResource = "WindowsFormsApp3.Report4.rdlc";
            ...
            this.tableAdapterManager.UpdateOrder = WindowsFormsApp3.Properties.DataSet2TableAdapters.TableAdapterManager.UpdateOrderOption.InsertUpdateDelete;
            // 
            // dataTablemTableAdapter
            // 
            this.dataTablemTableAdapter.ClearBeforeFill = true;
            // 
            // dataTableBindingSource1
            // 
            this.dataTableBindingSource1.DataMember = "DataTable";
            this.dataTableBindingSource1.DataSource = this.dataSet2BindingSource;
            // 
            // dataTablejustAdapter
            // 
            this.dataTablejustAdapter.ClearBeforeFill = true;
            // 
            ...
            this.dataTable1BindingSource1.DataSource = this.dataSet5BindingSource;
            // 
        ...
        private Properties.DataSet1TableAdapters.DataTable1TableAdapter dataTable1TableAdapter;
        private System.Windows.Forms.Label label1;
        private System.Windows.Forms.BindingSource DataTableBindingSource;
        private Properties.DataSet2 dataSet2;
        private System.Windows.Forms.BindingSource dataSet2BindingSource;
        private Microsoft.Reporting.WinForms.ReportViewer reportViewer2;
        private Properties.DataSet2TableAdapters.DataTableTableAdapter dataTableTableAdapter;
        private Properties.DataSet2TableAdapters.TableAdapterManager tableAdapterManager;
        private System.Windows.Forms.Button button2;
        private System.Windows.Forms.ComboBox comboBox2;
        private System.Windows.Forms.Label label2;
        private Properties.DataSet3 dataSet3;
        private System.Windows.Forms.BindingSource dataTablemBindingSource;
        private Properties.DataSet3TableAdapters.DataTablemTableAdapter dataTablemTableAdapter;
        private System.Windows.Forms.Panel panel1;
        private Microsoft.Reporting.WinForms.ReportViewer reportViewer3;
        private System.Windows.Forms.BindingSource dataTableBindingSource1;
        private Properties.DataSet4 dataSet4;
        private System.Windows.Forms.BindingSource datajustBindingSource;
        private Properties.DataSet4TableAdapters.DataTablejustAdapter dataTablejustAdapter;
        private System.Windows.Forms.BindingSource dataSet4BindingSource;
        private System.Windows.Forms.Panel panel2;
        private Microsoft.Reporting.WinForms.ReportViewer reportViewer1;
       
        
        private System.Windows.Forms.BindingSource datahodBindingSource;
        private Microsoft.Reporting.WinForms.ReportViewer reportViewer4;
        private System.Windows.Forms.BindingSource dataSet5BindingSource;
        private Properties.DataSet5 dataSet5;
